...
//
*/
Shader "Xerxes1138/Iridescence - textured"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass // One pass forward shader
		{
			...
			{
				half3 albedo = tex2D(_MainTex, i.uv_MainTex);

				// sample the normal map, and decode from the Unity encoding
				half3 tnormal = UnpackNormal(tex2D(_BumpMap, i.uv_MainTex));
